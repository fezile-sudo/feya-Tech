  ...
  return (
        ...
        cart.length === 0 ? (
          <Card className="shadow-sm">
            <CardBody className="text-center">
              ...
              <Button color="dark" tag={Link} to="/" className="mt-3"> Shopping </Button>
                  ...
                  <Card className="mb-3 shadow-sm" key={item.id} >
                    ...
                    <Row className="g-0 align-items-center">
                      ...
                      <Col md="4">
                        ...
                        <CardImg src={item.image} alt={item.title} style={{height: "180px", objectFit: "contain", padding: "15px" }} />
    ...
    <Col lg="4">
        ...
        <hr />
              ...
              <p>Subtotal<span className="float-end">R{cartTotal.toFixed(2)}</span> </p>

              <p>Shipping<span className="float-end text-success"> Free </span> </p>

              <p>VAT (15%)<span className="float-end"> R{vat.toFixed(2)}</span> </p>

                <hr />


              <h4>Total<span className="float-end">R{grandTotal.toFixed(2)}</span></h4>
